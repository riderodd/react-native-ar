...
class ArViewerView extends _react.Component {
  ...
  takeScreenshot() {
    ...
    this.nativeRef.current && _reactNative.UIManager.dispatchViewManagerCommand((0, _reactNative.findNodeHandle)(this.nativeRef.current), _reactNative.UIManager[ComponentName].Commands.takeScreenshot.toString(), [requestId]);
    return promise;
  }
  /**
  ...
  reset() {
    this.nativeRef.current && _reactNative.UIManager.dispatchViewManagerCommand((0, _reactNative.findNodeHandle)(this.nativeRef.current), _reactNative.UIManager[ComponentName].Commands.reset.toString(), []);
  }

  render() {
    return /*#__PURE__*/_react.default.createElement(ArViewerComponent, _extends({
      ref: this.nativeRef,
